...
int Deplacement(t_map carte, int tab[20][16], t_joueur* joueurActuel); //Recupere dans la struct position, la position fde la souris lors du click, renvoie le nb de PM utilisés
